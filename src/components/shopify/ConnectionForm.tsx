...
import { validateShopifyCredentials, testShopConnection, saveShopifyCredentials } from "@/services/shopify";
...
const ConnectionForm = ({ onConnect, onClose }: ConnectionFormProps) => {
  ...
  const handleConnect = async () => {
    ...
    try {
      ...
      if (isValid) {
        ...
        await saveShopifyCredentials(credentials);
